...
public class Ability1Potion : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        switch (GameController.ability1)
        {
            case "Big Heal Potion (potionObject)":
                ...
                atk1gear.transform.SetParent(GameObject.FindGameObjectWithTag("ability").transform, false);
                break;
            case "Small Health Potion (potionObject)":
                ...
                atk10gear.transform.SetParent(GameObject.FindGameObjectWithTag("ability").transform, false);
                break;
            case "Big sheild Potion (potionObject)":
                ...
                bigShield.transform.SetParent(GameObject.FindGameObjectWithTag("ability").transform, false);
                break;
            case "Small Shield Potion (potionObject)":
                ...
                smallShield.transform.SetParent(GameObject.FindGameObjectWithTag("ability").transform, false);
                break;
            case "Big Speed Potion (potionObject)":
                ...
                bigSpeed.transform.SetParent(GameObject.FindGameObjectWithTag("ability").transform, false);
                break;
            case "Small Speed Potion (potionObject)":
                ...
                smallSpeed.transform.SetParent(GameObject.FindGameObjectWithTag("ability").transform, false);
                break;
        }
    }
