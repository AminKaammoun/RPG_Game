...
public class BeachFishingShop : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Fish1Price = Random.Range(20, 41);
        Fish2Price = Random.Range(40, 101);
        Fish3Price = Random.Range(100, 201);
        Fish4Price = Random.Range(200, 501);
        Fish5Price = Random.Range(1000, 2001);
        ...
        if (number > 0)
        {
            switch (currentFish)
            {
                ...
                case "fish6":
                    ...
                    for (int i = 0; i < inventory.Container.Count; i++)
                    {
                        if (inventory.Container[i].item.name == "Coelacanth")
                        {
                ...
                case "fish7":
                    ...
                    for (int i = 0; i < inventory.Container.Count; i++)
                    {
                        if (inventory.Container[i].item.name == "Mahi-Mahi")
                        {
                            counter = inventory.Container[i].amount;
                        }
                    }
                ...
                case "fish8":
                    ...
                    for (int i = 0; i < inventory.Container.Count; i++)
                    {
                        if (inventory.Container[i].item.name == "Royal Blue Tang")
                        {
                            counter = inventory.Container[i].amount;
                        }
                    }
                ...
                case "fish9":
                    ...
                    for (int i = 0; i < inventory.Container.Count; i++)
                    {
                        if (inventory.Container[i].item.name == "Angler Fish")
                        {
                            counter = inventory.Container[i].amount;
                        }
                    }
                ...
                case "fish10":
                    ...
                    for (int i = 0; i < inventory.Container.Count; i++)
                    {
                        if (inventory.Container[i].item.name == "Oyster")
                        {
                            counter = inventory.Container[i].amount;
                        }
                    }
