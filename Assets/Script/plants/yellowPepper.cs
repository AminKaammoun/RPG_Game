...
public class yellowPepper : MonoBehaviour
{
    private float timeToGrow = 135f;
    ...
    void Update()
    {
        if (isWatered)
        {
            ...
            if (timeToGrow < 101.25 && timeToGrow >= 67.5)
            {
                spriteRenderer.sprite = sprites[1];
            }
            else if (timeToGrow < 67.5 && timeToGrow >= 33.75)
            {
                spriteRenderer.sprite = sprites[2];
            }
            else if (timeToGrow < 33.75 && timeToGrow > 0)
            {
