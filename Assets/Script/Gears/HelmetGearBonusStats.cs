...
public class HelmetGearBonusStats : MonoBehaviour
{
    ...
    void Update()
    {
        if (GameController.helmetAtkGemBonus > 0)
        {
            AtkBonus.text = "+(" + GameController.helmetAtkGemBonus + ")";
            switch (GameController.helmetAtkGemBonus)
            {
                case 5:
        ...
        if (GameController.helmetDefGemBonus > 0)
        {
            DefBonus.text = "+(" + GameController.helmetDefGemBonus + ")";
            switch (GameController.helmetDefGemBonus)
            {
                case 5:
        ...
        if (GameController.helmetAgiGemBonus > 0)
        {
            AgiBonus.text = "+(" + GameController.helmetAgiGemBonus + ")";
            switch (GameController.helmetAgiGemBonus)
            {
                case 5:
        ...
        if (GameController.helmetSpGemBonus > 0)
        {
            SpBonus.text = "+(" + GameController.helmetSpGemBonus + ")";
            switch (GameController.helmetSpGemBonus)
            {
                case 5:
        ...
        if (GameController.helmetHpGemBonus > 0)
        {
            HpBonus.text = "+(" + GameController.helmetHpGemBonus + ")";
            switch (GameController.helmetHpGemBonus)
            {
                case 25:
