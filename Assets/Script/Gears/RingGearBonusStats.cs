...
public class RingGearBonusStats : MonoBehaviour
{
    ...
    void Update()
    {
        if (GameController.ringAtkGemBonus > 0)
        {
            AtkBonus.text = "+(" + GameController.ringAtkGemBonus + ")";
            switch (GameController.ringAtkGemBonus)
            {
                case 5:
        ...
        if (GameController.ringDefGemBonus > 0)
        {
            DefBonus.text = "+(" + GameController.ringDefGemBonus + ")";
            switch (GameController.ringDefGemBonus)
            {
                case 5:
        ...
        if (GameController.ringAgiGemBonus > 0)
        {
            AgiBonus.text = "+(" + GameController.ringAgiGemBonus + ")";
            switch (GameController.ringAgiGemBonus)
            {
                case 5:
        ...
        if (GameController.ringSpGemBonus > 0)
        {
            SpBonus.text = "+(" + GameController.ringSpGemBonus + ")";
            switch (GameController.ringSpGemBonus)
            {
                case 5:
        ...
        if (GameController.ringHpGemBonus > 0)
        {
            HpBonus.text = "+(" + GameController.ringHpGemBonus + ")";
            switch (GameController.ringHpGemBonus)
            {
                case 25:
