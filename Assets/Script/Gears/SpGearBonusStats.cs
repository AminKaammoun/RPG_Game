...
public class SpGearBonusStats : MonoBehaviour
{
    ...
    void Update()
    {
        if (GameController.beltAtkGemBonus > 0)
        {
            AtkBonus.text = "+(" + GameController.beltAtkGemBonus + ")";
            switch (GameController.beltAtkGemBonus)
            {
                case 5:
        ...
        if (GameController.beltDefGemBonus > 0)
        {
            DefBonus.text = "+(" + GameController.beltDefGemBonus + ")";
            switch (GameController.beltDefGemBonus)
            {
                case 5:
        ...
        if (GameController.beltAgiGemBonus > 0)
        {
            AgiBonus.text = "+(" + GameController.beltAgiGemBonus + ")";
            switch (GameController.beltAgiGemBonus)
            {
                case 5:
        ...
        if (GameController.beltSpGemBonus > 0)
        {
            SpBonus.text = "+(" + GameController.beltSpGemBonus + ")";
            switch (GameController.beltSpGemBonus)
            {
                case 5:
        ...
        if (GameController.beltHpGemBonus > 0)
        {
            HpBonus.text = "+(" + GameController.beltHpGemBonus + ")";
            switch (GameController.beltHpGemBonus)
            {
                case 25:
