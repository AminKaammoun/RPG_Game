...
public class DefGearBonusStats : MonoBehaviour
{
    ...
    void Update()
    {
        if (GameController.shieldAtkGemBonus > 0)
        {
            AtkBonus.text = "+(" + GameController.shieldAtkGemBonus + ")";
            switch (GameController.shieldAtkGemBonus)
            {
                case 5:
        ...
        if (GameController.shieldDefGemBonus > 0)
        {
            DefBonus.text = "+(" + GameController.shieldDefGemBonus + ")";
            switch (GameController.shieldDefGemBonus)
            {
                case 5:
        ...
        if (GameController.shieldAgiGemBonus > 0)
        {
            AgiBonus.text = "+(" + GameController.shieldAgiGemBonus + ")";
            switch (GameController.shieldAgiGemBonus)
            {
                case 5:
        ...
        if (GameController.shieldSpGemBonus > 0)
        {
            SpBonus.text = "+(" + GameController.shieldSpGemBonus + ")";
            switch (GameController.shieldSpGemBonus)
            {
                case 5:
        ...
        if (GameController.shieldHpGemBonus > 0)
        {
            HpBonus.text = "+(" + GameController.shieldHpGemBonus + ")";
            switch (GameController.shieldHpGemBonus)
            {
                case 25:
