...
public class Ability2Potion : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        switch (GameController.ability2)
        {
            case "Big Heal Potion (potionObject)":
                ...
                atk1gear.transform.SetParent(GameObject.FindGameObjectWithTag("ability2").transform, false);
                break;
            case "Small Health Potion (potionObject)":
               var atk10gear = Instantiate(SmallHealth, transform.position + add, Quaternion.identity) as GameObject;
                atk10gear.transform.SetParent(GameObject.FindGameObjectWithTag("ability2").transform, false);
                break;
            case "Big sheild Potion (potionObject)":
                ...
                bigShield.transform.SetParent(GameObject.FindGameObjectWithTag("ability2").transform, false);
                break;
            case "Small Shield Potion (potionObject)":
                ...
                smallShield.transform.SetParent(GameObject.FindGameObjectWithTag("ability2").transform, false);
                break;
            case "Big Speed Potion (potionObject)":
                ...
                bigSpeed.transform.SetParent(GameObject.FindGameObjectWithTag("ability2").transform, false);
                break;
            case "Small Speed Potion (potionObject)":
                ...
                smallSpeed.transform.SetParent(GameObject.FindGameObjectWithTag("ability2").transform, false);
                break;
        }
